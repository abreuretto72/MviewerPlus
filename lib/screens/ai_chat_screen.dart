...
class _AiChatScreenState extends State<AiChatScreen> {
  ...
  void _initializeChat() {
    ...
    // Defer to next frame to allow build
    Future.microtask(() {
      ...
      setState(() {
        ...
        if (warning != null) {
          ...
          _messages.insert(0, {
            'role': 'model',
            'text': '⚠️ System Note: $warning\n\nI am ready to analyze your file. What would you like to know?'
          });
        } else {
           _messages.insert(0, {
            'role': 'model',
            'text': 'I have analyzed ${widget.fileName}. Ask me anything about its content!'
          });
        }
      });
    });
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_scrollController.hasClients) {
        _scrollController.animateTo(
          0, // Scroll to the "start" of the list, which is the bottom visually
            ...
            onPressed: () {
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: Text(AiService.getApiKeyInstructions()),
                  actions: [
                    TextButton(
            ...
            onSelected: (String newValue) {
              if (_selectedLanguage != newValue) {
                setState(() {
                  ...
                  _messages.clear(); // Clear history on language change to re-contextualize
                });
                _initializeChat();
              }
            },
